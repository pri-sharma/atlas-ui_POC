...
class KPICard extends Component {
    ...
    onDragEnd = (result) => {
        ...
        if(this.props.columns.includes(result.draggableId)) {
            ...
            this.setState({trackRowChanges: newList, data: newList, rowSelections: sourceList, trackColumnChanges: orderChange})
        }
...
export default withStyles(cellStyles)(KPICard);